...
#define OFFSET_COUNT_VALUE 		6000
#ifdef TRANSPOTTER
...
#define BAT_CALIB_REAL_VOLTAGE  3659      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
...
#define TEMP_CAL_LOW_ADC        1579      // temperature 1: ADC value
#define TEMP_CAL_LOW_DEG_C      183       // temperature 1: measured temperature [°C * 10]. Here 35.8 °C
#define TEMP_CAL_HIGH_ADC       1435      // temperature 2: ADC value
#define TEMP_CAL_HIGH_DEG_C     378       // temperature 2: measured temperature [°C * 10]. Here 48.9 °C
 ...
 */
  ...
  #define ADC1_MIN 710            // min ADC1-value while poti at minimum-position (0 - 4095)
  //#define ADC1_MID 2141         // mid ADC1-value while poti at minimum-position (ADC1_MIN - ADC1_MAX)
  #define ADC1_MAX 3590         // max ADC1-value while poti at maximum-position (0 - 4095)
...
// Control selections
#define CTRL_TYP_SEL    3                      // [-] Control type selection: 0 = Commutation , 1 = Sinusoidal, 2 = FOC Field Oriented Control (default)
...
#define STEER_COEFFICIENT   4096  // 0.5f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case  8192 = 0.5 * 2^14. If you do not want any steering, set it to 0. 
